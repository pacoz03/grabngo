...
const styles = StyleSheet.create({
    safeArea: { flex: 1, backgroundColor: '#F4F5F7' }, header: { alignItems: 'center', paddingHorizontal: 20, paddingTop: 40, paddingBottom: 10 }, headerTitle: { fontSize: 22, fontFamily: 'SpaceGrotesk-Bold', color: '#000' }, filterList: { paddingHorizontal: 20, paddingVertical: 10 }, section: { marginTop: 20 }, sectionTitle: { fontSize: 22, fontFamily: 'SpaceGrotesk-Bold', color: '#000', marginLeft: 20, marginBottom: 15 }, recipeList: { paddingLeft: 20 }, recommendedContainer: { paddingHorizontal: 20 }, noResults: { fontFamily: 'SpaceGrotesk-Regular', marginLeft: 20, color: '#666' }
});
